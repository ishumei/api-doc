...
| 参数名称          | **类型**    | **是否必选** | **说明**                                                     |
| ----------------- | ----------- | ------------ | ------------------------------------------------------------ |
| riskType          | int         | Y            | 风险类型：<br/>`0`：正常<br/>`100`：摄政<br/>`200`：色情<br/>`210`：辱骂<br/>`300`：广告<br/>`400`：灌水<br/>`500`：无意义<br/>`600`：违禁<br/>`700`：其他<br/>`720`：黑账号<br/>`730`：黑IP<br/>`800`：高危账号<br/>`900`：自定义 |
