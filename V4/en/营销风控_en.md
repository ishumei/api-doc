# DeepCleer Skynet - Marketing Risk Control
...
| deviceId        | string   | DeepCleer device fingerprint identifier, generated by DeepCleer SDK                                                                                                                 | Strongly Recommended     | DeepCleer device fingerprint identifier, used for user behavior analysis.<br/>Note:<br/>1. For versions before integrating DeepCleer SDK, if the deviceId cannot be obtained, pass an empty string "";                                                          <br/>     2. Directly pass the original field obtained by getDeviceId without decryption |
| os              | string   | Application end operating system type                                                                                                                              | Strongly Recommended     | Optional values: `android、harmony、ios、weapp、web、aliapp：Alipay Mini-Program Engine、ttapp：Douyin Mini-Program、tmapp：Tmall Mini-Program、mcp：Through the agent invocation`                                                                                                                                                                                                   |
