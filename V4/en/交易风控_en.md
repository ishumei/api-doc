# DeepCleer Skynet - Transaction Risk Control
...
| smid                | string     | Unique device identifier                                 | This field will only be returned if the deviceId field is passed and DeepCleer is contacted to enable the configuration |
