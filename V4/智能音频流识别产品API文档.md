...
| tokenProfileLabels  | json_array  | 账号属性标签           | 否           | 仅在开启功能时返回[详见tokenProfileLabels，tokenRiskLabels参数](#tokenProfileLabels,tokenRiskLabels)                                                                        |
| tokenRiskLabels  | json_array  | 账号风险标签           | 否           | 仅在开启功能时返回[详见tokenProfileLabels，tokenRiskLabels参数](#tokenRiskLabels,tokenRiskLabels)                                                                        |
