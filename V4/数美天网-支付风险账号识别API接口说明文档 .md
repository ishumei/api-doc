...
| tranDate      | string | 交易日期      | 必传字段 | ESB接口字段，格式为YYYYMMDD                                                         |
| tranTimestamp | string | 交易时间      | 必传字段 | ESB接口字段，格式为HHMMSSNNN                                                        |
| sourceType        | string | 渠道类型          | 必传字段 | ESB接口字段，各系统提供渠道类型说明                                                 |
| seqNo         | string | 渠道流水号        | 必传字段 | ESB接口字段                                                                         |
...
| tranDate      | string | 交易日期  | 必传字段 | ESB接口字段，格式为YYYYMMDD                       |
| tranTimestamp | string | 交易时间  | 必传字段 | ESB接口字段，格式为HHMMSSNNN                      |
| sourceType        | string | 渠道类型      | 必传字段 | ESB接口字段，各系统提供渠道类型说明，渠道表见下表 |
| seqNo         | string | 渠道流水号    | 必传字段 | ESB接口字段                                           |
| systemId      | string | 上游系统标识  | 强烈建议 | ESB接口字段                                           |
| partnerId     | string | 合作方标识    | 强烈建议 | ESB接口字段                                           |
| logId         | string | 全局流水号    | 强烈建议 | ESB接口字段                                           |
