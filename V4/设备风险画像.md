...
<img width="538" alt="企业微信截图_16825797212579" src="https://user-images.githubusercontent.com/57123035/234789244-41969b49-39fb-46eb-b5c1-9b2f66b05914.png">
...
| --- | --- | --- | --- | --- |
| deviceId | string | 待查询的设备指纹ID，由数美SDK生成 | 必传 | 该ID为用户设备的唯一标识，且与其他数美接口的smid保持一致 |
...
| devicePrimayInfo   | json_object | 设备基础属性标签  | 否  | 返回设备基础属性标签，见下面详情内容。该服务需要单独开通，涉及到收费，如果需要请联系商务同学 |
