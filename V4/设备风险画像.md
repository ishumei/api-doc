...
| 基站信息	                                                                             | cell	                     | 基站信息	                                                                                                        | "cell": {<br/> "cid": "12345",<br/> "lac": "12345",<br/> "type": "gsm"<br/> }                                                                                                                                                                                                                                         |
| 移动网络号码	                                                                          | mnc	                      | 移动网络号码	                                                                                                      | "mnc":"65535"                                                                                                                                                                                                                                                       |
| 移动信号国家码	                                                                        | mcc	                      | 移动信号国家码	                                                                                                    | "mcc":"65535"                                                                                                                                                                                                                                                       |
| 公网ip	                                                                               | ip	                       | 公网ip	                                                                                                         | "ip":"1.1.1.1"                                                                                                                                                                                                                                                      |
...
```json
{
  ...
  "deviceLabels": {
    ...
    "device_active_info": {
      ...
      "s_drmId": "Zp2Cn5jSgm/Mw4bhFC51GWrZKdnJ1hBxc/dBeZTL0lY="
    },
    "monkey_device": {
      "common": {
        "b_monkey_apps": 1,
