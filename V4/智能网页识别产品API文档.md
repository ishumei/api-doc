...
| **请求参数名**           | **类型**      | **参数说明**          | **是否必传** | **规范**                                                                                                                                                                                                                                                                                                                                        |
|---------------------|-------------|-------------------|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| url                 | string      | 要检测的网页链接          | N        | 网址链接可下载，其中网址头部的content-type需为text/html。<br/>内容大小`500M`以内，文本长度默认限制`50万`字，图片张数默认限制`500张`。（url、text、contents传且只能传其中一个）                                                                                                                                                                                                                           |
...
其中，<span id="articleDynamicConfig">articleDynamicConfig</span>的内容如下：
