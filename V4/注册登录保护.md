...
| type                  | string | 注册方式： 包括手机号码一键注册、手机号验证码注册、第三方授权、用户名密码注册、小程序本体授权注册、小程序本体手机号快捷注册、邮箱验证码注册、邮箱验证链接注册、Whatsapp手机号验证码注册 | 必传参数     | 可选值：<br/>`phoneOnePass`:手机号一键注册<br/>`phoneMessage`:手机号验证码注册<br/>`signupPlatform`:第三方授权<br/>`userPassword`:用户名密码注册<br/>`signupWeapp`:小程序本体授权注册<br/>`phoneWeapp`:小程序本体手机号快捷注册<br/>`emailMessage`:邮箱验证码注册<br/>`emailLink`:邮箱验证链接注册<br/>`whatsappMessage`:Whatsapp手机号验证码注册<br/> |
