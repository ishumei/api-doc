...
- [智能音频文件识别API文档](#智能音频文件识别api文档)
- [**1. API接口描述**](#1-api接口描述)
  - [**1.1 请求参数**](#11-请求参数)
    - [**同步返回参数**](#同步返回参数)
    - [**回调结果**](#回调结果)
  - [**1.2 主动查询结果**](#12-主动查询结果)
    - [**请求参数**](#请求参数)
    - [**返回参数**](#返回参数)
  - [**1.3 示例**](#13-示例)
    - [**上传请求示例**](#上传请求示例)
...
| type           | string      | 检测的风险类型       | 必传参数     | <p>POLITICS：涉政识别</p><p>PORN：色情识别</p><p>AD：广告识别<br>ANTHEN：国歌识别</p><p>MOAN：娇喘识别</p><p>ABUSE：辱骂识别<br>GENDER：性别识别</p><p>TIMBRE：音色识别</p><p>SING：唱歌识别</p><p>LANGUAGE：语种识别</p><p></p><p>如需识别音色，唱歌,语种GENDER必传</p><p>如需做组合识别，通过下划线连接即可，例如POLITICS_PORN_MOAN涉政、色情和娇喘识别</p><p>建议传入：<br>POLITICS_PORN_AD_MOAN</p> |
...
| data           | json object | 本次请求相关信息     | 必传参数     | 最长1MB                                                                                                                                                                                                                                                                                                                                                                                                 |
