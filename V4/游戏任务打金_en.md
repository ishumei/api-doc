...
| os              | string   | Application end operating system type                                                                                                                              | Strongly recommended     | Optional values: `android, ios, weapp, harmony, web`;<br/>If the registration event comes from the official website registration, the os of the registration event is passed as "web"                                                                                                                                                                                                 |
